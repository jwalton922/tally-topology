...
public class ModifiedMemoryMapState<T> implements Snapshottable<T>, ITupleCollection, MapState<T> {

    MemoryMapStateBacking<OpaqueValue> _backing;
    SnapshottableMap<T> _delegate;

    public ModifiedMemoryMapState(String id) {
    ...
    public static class Factory implements StateFactory {
        ...
        public State makeState(Map conf, IMetricsContext metrics, int partitionIndex, int numPartitions) {
            return new ModifiedMemoryMapState(_id + partitionIndex);
        }
    }
